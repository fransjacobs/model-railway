...
public class TurnoutPanel extends JPanel {
  ...
  private void newBtnActionPerformed(ActionEvent evt) {//GEN-FIRST:event_newBtnActionPerformed
    ...
    selectedTurnout = new Switch(0, "U", null);
  ...
  private void turnoutTableMouseClicked(MouseEvent evt) {//GEN-FIRST:event_turnoutTableMouseClicked
    ...
    Switch t = this.turnoutTableModel.getControllableDeviceAt(row);
    if (t != null) {
  ...
  private void saveBtnActionPerformed(ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
    ...
    Switch t = TrackServiceFactory.getTrackService().getSwitchTurnout(selectedTurnout.getAddress());
    if (t != null) {
  ...
  protected Switch setTurnoutValues() {
    ...
    Switch t = new Switch(address, description, catalogNumber);
    t.setName(name);
    
    return t;
  }

  protected void setComponentValues(Switch turnout) {
    if (turnout != null) {
  ...
  private Switch selectedTurnout;
