 ...
 * @author frans
 */
public class DiagnosticPanel extends JPanel implements HeartBeatListener {
    ...
    private void postInit() {
        ...
        if (TrackServiceFactory.getTrackService() != null) {
            //ServiceInfo trackServiceSI = TrackServiceFactory.getTrackService().getServiceInfo();
            //ServiceInfo feedbackSI = TrackServiceFactory.getTrackService().getFeedbackInfo();
            ControllerInfo ci = TrackServiceFactory.getTrackService().getControllerInfo();

            //if (trackServiceSI != null) {
            //  this.trackServiceHostNameLbl.setText(trackServiceSI.getIp());
            //  this.trackServiceNameLbl.setText(trackServiceSI.getServiceName());
            //}
            if (ci != null) {
                this.controllerNameLbl.setText(ci.getDescription() + " " + ci.getCatalogNumber() + " " + ci.getSerialNumber());
                //this.feedbackServiceNameLbl.setText(feedbackSI.getServiceName());
            }
  ...
  private void initComponents() {
    ...
    trackServiceHostLbl = new JLabel();
    trackServiceHostNameLbl = new JLabel();
    trackServiceLbl = new JLabel();
    trackServiceNameLbl = new JLabel();
    controllerLbl = new JLabel();
    controllerNameLbl = new JLabel();
    feedbackServiceLbl = new JLabel();
    feedbackServiceNameLbl = new JLabel();
    ...
    trackServiceHostLbl.setHorizontalAlignment(SwingConstants.TRAILING);
    trackServiceHostLbl.setText("Track Service Host:");
    trackServiceHostLbl.setName("trackServiceHostLbl"); // NOI18N
    topRightPanel.add(trackServiceHostLbl);

    trackServiceHostNameLbl.setText("...");
    trackServiceHostNameLbl.setName("trackServiceHostNameLbl"); // NOI18N
    topRightPanel.add(trackServiceHostNameLbl);

    trackServiceLbl.setHorizontalAlignment(SwingConstants.TRAILING);
    trackServiceLbl.setLabelFor(trackServiceNameLbl);
    trackServiceLbl.setText("Track Service:");
    trackServiceLbl.setName("trackServiceLbl"); // NOI18N
    topRightPanel.add(trackServiceLbl);

    trackServiceNameLbl.setText("...");
    trackServiceNameLbl.setName("trackServiceNameLbl"); // NOI18N
    topRightPanel.add(trackServiceNameLbl);

    controllerLbl.setHorizontalAlignment(SwingConstants.TRAILING);
    controllerLbl.setText("Controller Service:");
    controllerLbl.setName("controllerLbl"); // NOI18N
    topRightPanel.add(controllerLbl);

    controllerNameLbl.setText("...");
    controllerNameLbl.setName("controllerNameLbl"); // NOI18N
    topRightPanel.add(controllerNameLbl);

    feedbackServiceLbl.setHorizontalAlignment(SwingConstants.TRAILING);
    feedbackServiceLbl.setText("Feedback Service:");
    feedbackServiceLbl.setName("feedbackServiceLbl"); // NOI18N
    topRightPanel.add(feedbackServiceLbl);

    feedbackServiceNameLbl.setText("...");
    feedbackServiceNameLbl.setName("feedbackServiceNameLbl"); // NOI18N
    topRightPanel.add(feedbackServiceNameLbl);
  ...
  private JLabel feedbackServiceLbl;
  private JLabel feedbackServiceNameLbl;
  ...
  private JLabel trackServiceHostLbl;
  private JLabel trackServiceHostNameLbl;
  private JLabel trackServiceLbl;
  private JLabel trackServiceNameLbl;
