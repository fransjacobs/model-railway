 ...
 *
 * Credits to: - https://www.jmri.org - https://github.com/palaziv/Maerklin-Controlling-Framework
 *
 * @author Frans Jacobs
 */
public class CanMessageFactory implements MarklinCan {
  ...
  private static int cs2UID = -1;

  public static void setCs2Uid(int uid) {
    cs2UID = uid;
  }
  ...
  public static CanMessage getPingRequest() {
    ...
    System.arraycopy(MarklinCan.DEVICE_UID, 0, data, 0, DEVICE_UID.length);
    System.arraycopy(VERSION, 0, data, 4, VERSION.length);
    System.arraycopy(DEVICE_IDENTIFIER, 0, data, 6, VERSION.length);
  ...
  public static CanMessage stop(int[] cs2Uid) {
    int[] data = getEmptyData();
    if (cs2Uid != null) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, SYSTEM_COMMAND, STOP_AND_GO_DLC, data,cs2UID);
    return cm;
  }

  public static CanMessage go(int[] cs2Uid) {
    int[] data = getEmptyData();
    if (cs2Uid != null) {
      System.arraycopy(cs2Uid, 0, data, 0, cs2Uid.length);
    }
  ...
  public static CanMessage switchAccessory(int address, AccessoryValue value, boolean on) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, ACCESSORY_SWITCHING, ACCESSORY_SWITCHING_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage statusConfig(int[] cs2Uid) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, STATUS_CONFIG, STATUS_CONFIG_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage queryFunction(int address, int functionNumber) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, LOC_FUNCTION, LOC_FUNCTION_QUERY_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage setFunction(int address, int functionNumber, int value) {
    ...
    data[4] = functionNumber & 0xff;
    data[5] = value & 0xff;
    CanMessage cm = new CanMessage(PRIO_1, LOC_FUNCTION, LOC_FUNCTION_SET_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage queryDirection(int address) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, LOC_DIRECTION, LOC_DIRECTION_QUERY_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage setDirection(int address, int cs2direction) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, LOC_DIRECTION, LOC_DIRECTION_SET_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage querySpeed(int address) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, LOC_SPEED, LOC_SPEED_QUERY_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage setLocSpeed(int address, int speed) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, LOC_SPEED, LOC_SPEED_SET_DLC, data,cs2UID);
    return cm;
  }
  ...
  public static CanMessage requestConfig(String filename) {
    ...
    CanMessage cm = new CanMessage(PRIO_1, REQUEST_CONFIG_DATA, REQUEST_CONFIG_DATA_DLC, data,cs2UID);
    return cm;
  }
...
//	}
  ...
  public static void main(String[] a) {
    ...
    System.out.println("stop : " + stop(null));
    System.out.println("go   : " + go(null));
