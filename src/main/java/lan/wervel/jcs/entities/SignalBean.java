...
public class SignalBean extends SolenoidAccessory {
    ...
    public SignalBean(Integer address, String description, String catalogNumber) {
        this(address, description, catalogNumber, null, null, null, 2, null, null, null, null);
    }

    public SignalBean(Integer address, String description, String catalogNumber, AccessoryValue value, Integer lightImages, Integer address2, AccessoryValue value2) {
        this(address, description, catalogNumber, null, value, null, lightImages, null, address2, value2, null);
    }

    public SignalBean(Integer address, String description, String catalogNumber, BigDecimal id, AccessoryValue value, BigDecimal soacId, Integer lightImages, SignalValue signalValue) {
        this(address, description, catalogNumber, id, value, soacId, lightImages, null, null, null, signalValue);
    }

    public SignalBean(Integer address, String description, String catalogNumber, BigDecimal id, AccessoryValue value, BigDecimal soacId, Integer lightImages, BigDecimal id2, Integer address2, AccessoryValue value2, SignalValue signalValue) {
...
//  @Override
//  public SignalBean copy() {
//    return new SignalBean(address, description, catalogNumber, id, value, soacId, lightImages, id2, address2, value2, signalValue);
//  }
    @Override
    public int hashCode() {
        int hash = 7;
    ...
    public boolean equals(Object obj) {
        ...
        final SignalBean other = (SignalBean) obj;
