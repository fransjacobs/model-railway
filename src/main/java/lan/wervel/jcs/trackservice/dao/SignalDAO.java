...
public class SignalDAO extends AbstractDAO<Signal> {
    ...
    protected Signal map(ResultSet rs) throws SQLException {
        ...
        BigDecimal id2 = rs.getBigDecimal(10);
        int a2 = rs.getInt(11);
        ...
        String currentStatusType2 = rs.getString(12); 
    ...
    protected void bind(PreparedStatement ps, Signal signal) throws SQLException {
        ...
        if (signal.getSwitchTime() != null) {
            ps.setInt(10, signal.getSwitchTime());
        } else {
            ps.setNull(10, Types.INTEGER);
        }

        ps.setBigDecimal(11, signal.getId());
    }
