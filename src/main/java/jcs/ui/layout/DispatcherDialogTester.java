 ...
 */
public class DispatcherDialogTester extends javax.swing.JDialog {
   ...
   */
  public DispatcherDialogTester(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  }
  ...
  private void initComponents() {
    ...
    getContentPane().add(dispatcherStatusPanel1, java.awt.BorderLayout.CENTER);
