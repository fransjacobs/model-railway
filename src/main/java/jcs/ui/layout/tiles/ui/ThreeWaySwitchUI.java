...
public class ThreeWaySwitchUI extends TileUI implements MouseListener, MouseMotionListener {

  public ThreeWaySwitchUI() {
  }

  public static ComponentUI createUI(JComponent c) {
    return new ThreeWaySwitchUI();
  }
  ...
  protected void renderDiagonalSouth(Graphics2D g2, Color color, JComponent c) {
    Tile tile = (Tile) c;
  ...
  protected void renderRouteDiagonalSouth(Graphics2D g2, Color color, JComponent c) {
    Tile tile = (Tile) c;

    int[] xPoints = new int[]{400, 400, 190, 210};
    int[] yPoints = new int[]{190, 210, 0, 0};
  ...
  protected void renderDiagonalNorth(Graphics2D g2, Color color, JComponent c) {
    Tile tile = (Tile) c;
    int[] xPoints = new int[]{400, 400, 170, 230};
    int[] yPoints = new int[]{170, 230, 0, 0};
  ...
  protected void renderRouteDiagonalNorth(Graphics2D g2, Color color, JComponent c) {
    Tile tile = (Tile) c;
    int[] xPoints = new int[]{400, 400, 190, 210};
  ...
  public void mousePressed(MouseEvent e) {
    ...
    if (isControlMode((Component) e.getSource()) && e.getButton() == MouseEvent.BUTTON1) {
      ...
      if (tile.getAccessoryBean() != null) {
        ...
        //TODO make the toggle dependend on the number of states
        ab.toggle();
