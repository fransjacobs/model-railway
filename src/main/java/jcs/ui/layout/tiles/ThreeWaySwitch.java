...
public class ThreeWaySwitch extends Switch implements AccessoryEventListener {
  ...
  public ThreeWaySwitch(Orientation orientation, Direction direction, int x, int y) {
    this(orientation, direction, x, y, DEFAULT_WIDTH, DEFAULT_HEIGHT);
  }

  public ThreeWaySwitch(Orientation orientation, Direction direction, int x, int y, int width, int height) {
    this(TileType.THREEWAY, orientation, direction, x, y, width, height);
  }
  ...
  public ThreeWaySwitch(TileBean tileBean) {
  ...
  public String getUIClassID() {
    return ThreeWaySwitchUI.UI_CLASS_ID;
  }

  @Override
  public void updateUI() {
    UIManager.put(TileUI.UI_CLASS_ID, "jcs.ui.layout.tiles.ui.ThreeWaySwitchUI");
