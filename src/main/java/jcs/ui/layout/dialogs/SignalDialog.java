...
public class SignalDialog extends javax.swing.JDialog {
   ...
   * @param tile
   */
  public SignalDialog(java.awt.Frame parent, Tile tile) {
    super(parent, true);
    this.signal = (Signal) tile;
    initComponents();
  ...
  private void postInit() {
    ...
    if (this.signal != null) {
      ...
      CommandStationFactory.getDispatcher().removeAccessoryEventListener(signal);
    }
  }
    ...
    private void saveExitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveExitBtnActionPerformed
      if (this.signal != null && this.signal.getAccessoryBean() != null) {
        if (this.signal.getAccessoryBean().getName() != null) {
          ...
          CommandStationFactory.getDispatcher().addAccessoryEventListener(signal);
        } else {
