...
/**
 *
 * @param <T> the object to "shuttle"
 */
public class Shuttle<T> extends JPanel {

  private static final long serialVersionUID = 5383882478992457817L;

  protected final SortedListModel<T> sourceListModel;
  protected final SortedListModel<T> destListModel;

  /**
   * Creates a ShuttlePanel
   */
  public Shuttle() {
  ...
  protected void fillListModel(SortedListModel<T> model, ListModel<T> newValues) {
  ...
  public List<T> getSelectableItems() {
    return sourceListModel.getAllElements();
  }

  public List<T> getSelectedItems() {
    return destListModel.getAllElements();
  }
  ...
  protected void clearSourceSelected() {
...
//    }
  ...
  protected void clearDestinationSelected() {
...
//    }
  ...
  protected class SortedListModel<T> extends AbstractListModel<T> {

    private static final long serialVersionUID = 4953952860580655243L;

    protected final SortedSet<T> model;
