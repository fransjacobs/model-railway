...
public class Locomotive extends ControllableDevice {
    ...
    public boolean isF5() {
        return getFunctionValue(5);
    }

    public final void setF5(boolean f5) {
        setFunctionValue(5, f5);
    }

    public boolean isF6() {
        return getFunctionValue(6);
    }

    public final void setF6(boolean f6) {
        setFunctionValue(6, f6);
    }

    public boolean isF7() {
        return getFunctionValue(7);
    }

    public final void setF7(boolean f7) {
        setFunctionValue(7, f7);
    }

    public boolean isF8() {
        return getFunctionValue(8);
    }

    public final void setF8(boolean f8) {
        setFunctionValue(8, f8);
    }
