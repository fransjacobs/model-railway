...
public class SwitchBean extends SolenoidAccessory {

    public SwitchBean() {
        this(null, "?", null, null, null);
    }

    public SwitchBean(Integer address, String description) {
        this(address, description, null, null, null);
    }

    public SwitchBean(Integer address, String description, String catalogNumber) {
        this(address, description, catalogNumber, null, null);
    }

    public SwitchBean(Integer address, String description, String catalogNumber, BigDecimal id) {
        this(address, description, catalogNumber, id, null);
    }

    public SwitchBean(Integer address, String description, String catalogNumber, BigDecimal id, AccessoryValue value) {
