...
//  }
  public StateMachine(Dispatcher dispatcher, AbstractState initialState) {
    super(dispatcher.getThreadGroup(), "STM->" + dispatcher.getLocomotiveBean().getName().toUpperCase());
    this.dispatcher = dispatcher;
    this.currentState = initialState;
    this.currentState.onEnter(dispatcher.getSensorMonitor());
...
//  Logger.trace(getName() + " Started. State " + dispatcherState.getName() + "...");
    ...
    while (running) {
      ...
      if (nextState != currentState) {
        ...
        currentState.onEnter(dispatcher.getSensorMonitor());
      }
...
//    AbstractState previousState = dispatcherState;
...
//    AbstractState currentState = dispatcherState;
