...
INSERT INTO jcs.tiles (id,tile_type,orientation,direction,x,y,signal_type,accessory_id,sensor_id) VALUES
	 ...
	 ('st-25','Straight','South','Center',540,340,NULL,NULL,NULL),
	 ('et-1','End','West','Center',260,300,NULL,NULL,NULL),
	 ('bk-4','Block','North','Center',540,140,NULL,NULL,NULL),
	 ('bk-3','Block','North','Center',540,460,NULL,NULL,NULL),
	 ('st-27','Straight','South','Center',540,540,NULL,NULL,NULL),
	 ('st-26','Straight','South','Center',540,380,NULL,NULL,NULL),
	 ('cr-1','Crossing','North','Center',540,300,NULL,NULL,NULL);
INSERT INTO jcs.tiles (id,tile_type,orientation,direction,x,y,signal_type,accessory_id,sensor_id) VALUES
	 ('et-3','End','South','Center',540,580,NULL,NULL,NULL),
