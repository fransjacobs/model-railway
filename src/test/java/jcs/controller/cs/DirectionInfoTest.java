...
import jcs.controller.cs.can.parser.DirectionInfo;
...
public class DirectionInfoTest {
  ...
  @Before
  public void setUp() {
    message = new CanMessage(ByteUtil.toByteArray(new int[]{0x00, 0x0a, 0xcb, 0x13, 0x04, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x00}));
    CanMessage response = new CanMessage(ByteUtil.toByteArray(new int[]{0x00, 0x0b, 0xcb, 0x13, 0x08, 0x00, 0x00, 0x00, 0x0c, 0x02, 0x00, 0x00, 0x00}));
