...
public class LayoutTileTest {
    ...
    public void testGetAdjacentPointsDiagonalEW() {
        ...
        LayoutTile instanceE = new LayoutTile(TileType.CURVED, Orientation.EAST, "Center", 100, 100);
        LayoutTile instanceW = new LayoutTile(TileType.CURVED, Orientation.WEST, "Center", 100, 100);
        Set<Point> expResult = new HashSet<>();
    ...
    public void testGetAdjacentPointsDiagonalNS() {
        ...
        LayoutTile instanceE = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 100, 100);
        LayoutTile instanceW = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 100, 100);
        Set<Point> expResult = new HashSet<>();
    ...
    public void testIsNeighbourStraightEastWest() {
        ...
        LayoutTile adjacentNE = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 140, 80);
        LayoutTile adjacentSE = new LayoutTile(TileType.CURVED, Orientation.EAST, "Center", 140, 120);
        LayoutTile adjacentSW = new LayoutTile(TileType.CURVED, Orientation.WEST, "Center", 60, 80);
        LayoutTile adjacentNW = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 60, 120);
    ...
    public void testIsNeighbourStraightNorthSouth() {
        ...
        assertFalse(resultN);
        //Check adjacent diagonal
        LayoutTile adjacentNE = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 120, 60);
        LayoutTile adjacentSE = new LayoutTile(TileType.CURVED, Orientation.EAST, "Center", 80, 60);
        LayoutTile adjacentSW = new LayoutTile(TileType.CURVED, Orientation.WEST, "Center", 120, 140);
        LayoutTile adjacentNW = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 80, 140);
    ...
    public void testIsNeighbourDiagonalEastWest() {
        ...
        LayoutTile instanceNE = new LayoutTile(TileType.CURVED, Orientation.EAST, "Center", 60, 60);
        LayoutTile instanceNW = new LayoutTile(TileType.CURVED, Orientation.WEST, "Center", 140, 140);
        LayoutTile instanceSE = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 100, 140);
        LayoutTile instanceSW = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 100, 60);
    ...
    public void testIsNeighbourDiagonalNorthSouth() {
        ...
        LayoutTile instanceN = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 100, 100);
        LayoutTile instanceS = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 100, 100);
        ...
        LayoutTile instanceNE = new LayoutTile(TileType.CURVED, Orientation.EAST, "Center", 100, 140);
        LayoutTile instanceNW = new LayoutTile(TileType.CURVED, Orientation.WEST, "Center", 100, 60);
        LayoutTile instanceSE = new LayoutTile(TileType.CURVED, Orientation.NORTH, "Center", 140, 60);
        LayoutTile instanceSW = new LayoutTile(TileType.CURVED, Orientation.SOUTH, "Center", 60, 140);
...
//INSERT INTO "JCS"."LAYOUTTILES" (ID,TILETYPE,ORIENTATION,DIRECTION,X,Y,SOAC_ID,SENS_ID) VALUES (8,'StraightTrack','West','Center',200,260,null,null);
    ...
    public void testIsNeighbours() {
        ...
        LayoutTile tile2 = new LayoutTile(new BigDecimal(2), TileType.CURVED, Orientation.NORTH, "Center", 160, 160);
        LayoutTile tile3 = new LayoutTile(new BigDecimal(3), TileType.CURVED, Orientation.EAST, "Center", 240, 160);
        ...
        LayoutTile tile6 = new LayoutTile(new BigDecimal(6), TileType.CURVED, Orientation.WEST, "Center", 160, 240);
        LayoutTile tile7 = new LayoutTile(new BigDecimal(7), TileType.CURVED, Orientation.SOUTH, "Center", 240, 240);
