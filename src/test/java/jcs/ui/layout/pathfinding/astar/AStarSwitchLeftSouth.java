 ...
 */
public class AStarSwitchLeftSouth {

  private final PersistenceTestHelper testHelper;

  public AStarSwitchLeftSouth() {
  ...
  @Before
  public void setUp() {
    testHelper.runTestDataInsertScript("layout_switch_left_south.sql");
  }
  ...
  public void testFindPath_bk_4m_bk3p() {
    ...
    List<Tile> tiles = jcs.ui.layout.tiles.TileCache.loadTiles(false);
    instance.buildGraph(tiles);
    String expPath = "[bk-4-]->[bk-3+]: bk-4-[bk-4] -> st-29 -> st-30 -> sw-1[GREEN] -> st-25 -> st-26 -> bk-3+[bk-3]";
  ...
  public void testRouteAll() {
    ...
    String r1 = "Route: [bk-3+]->[bk-4-]: bk-3 -> bk-3+[bk-3] -> st-26 -> st-25 -> sw-1[GREEN] -> st-30 -> st-29 -> bk-4-[bk-4]";
    String r2 = "Route: [bk-3+]->[bk-1+]: bk-3 -> bk-3+[bk-3] -> st-26 -> st-25 -> sw-1[RED] -> st-2 -> st-1 -> bk-1+[bk-1]";
    String r3 = "Route: [bk-4-]->[bk-3+]: bk-4 -> bk-4-[bk-4] -> st-29 -> st-30 -> sw-1[GREEN] -> st-25 -> st-26 -> bk-3+[bk-3]";
    String r4 = "Route: [bk-1+]->[bk-3+]: bk-1 -> bk-1+[bk-1] -> st-1 -> st-2 -> sw-1[RED] -> st-25 -> st-26 -> bk-3+[bk-3]";
