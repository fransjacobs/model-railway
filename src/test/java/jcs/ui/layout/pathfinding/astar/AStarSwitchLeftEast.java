 ...
 */
public class AStarSwitchLeftEast {

  private final PersistenceTestHelper testHelper;

  public AStarSwitchLeftEast() {
  ...
  @Before
  public void setUp() {
    testHelper.runTestDataInsertScript("layout_switch_left_east.sql");
  }
  ...
  public void testFindPath_bk_2m_bk3p() {
    ...
    List<Tile> tiles = TileFactory.toTiles(PersistenceFactory.getService().getTileBeans(), false, false);
    instance.buildGraph(tiles);
    String expPath = "[bk-2-]->[bk-3+]: bk-2-[bk-2] -> st-6 -> st-5 -> sw-1[RED] -> st-25 -> st-26 -> bk-3+[bk-3]";
  ...
  public void testRouteAll() {
    ...
    String r1 = "Route: [bk-2-]->[bk-3+]: bk-2 -> bk-2-[bk-2] -> st-6 -> st-5 -> sw-1[RED] -> st-25 -> st-26 -> bk-3+[bk-3]";
    String r2 = "Route: [bk-2-]->[bk-1+]: bk-2 -> bk-2-[bk-2] -> st-6 -> st-5 -> sw-1[GREEN] -> st-2 -> st-1 -> bk-1+[bk-1]";
    String r3 = "Route: [bk-1+]->[bk-2-]: bk-1 -> bk-1+[bk-1] -> st-1 -> st-2 -> sw-1[GREEN] -> st-5 -> st-6 -> bk-2-[bk-2]";
    String r4 = "Route: [bk-3+]->[bk-2-]: bk-3 -> bk-3+[bk-3] -> st-26 -> st-25 -> sw-1[RED] -> st-5 -> st-6 -> bk-2-[bk-2]";
