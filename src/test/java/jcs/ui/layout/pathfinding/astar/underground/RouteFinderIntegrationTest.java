 ...
 */
package jcs.ui.layout.pathfinding.astar.underground;

import jcs.ui.layout.pathfinding.demo.astar2.underground.HaversineScorer;
import jcs.ui.layout.pathfinding.demo.astar2.underground.Station;
...
import jcs.ui.layout.pathfinding.demo.astar2.Graph;
import jcs.ui.layout.pathfinding.demo.astar2.RouteFinder;
...
public class RouteFinderIntegrationTest {
  ...
  public void findRoute() {
    ...
    route.stream().map(Station::getName).collect(Collectors.toList()).forEach(station -> Logger.debug(station));
  }
}
