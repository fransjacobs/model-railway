...
public class AStarCrossRightSouth {
  ...
  public void testFindPath_bk_2m_bk3p() {
    ...
    List<Tile> tiles = jcs.ui.layout.tiles.TileCache.loadTiles(false);
    instance.buildGraph(tiles);
    String expPath = "[bk-2-]->[bk-3+]: bk-2-[bk-2] -> st-6 -> st-5 -> cs-2[RED] -> st-25 -> st-26 -> bk-3+[bk-3]";
  ...
  public void testRouteAll() {
    ...
    String r1 = "Route: [bk-2-]->[bk-3+]: bk-2 -> bk-2-[bk-2] -> st-6 -> st-5 -> cs-2[RED] -> st-25 -> st-26 -> bk-3+[bk-3]";
    ...
    String r4 = "Route: [bk-1+]->[bk-2-]: bk-1 -> bk-1+[bk-1] -> st-1 -> st-2 -> cs-2[GREEN] -> st-5 -> st-6 -> bk-2-[bk-2]";
    String r5 = "Route: [bk-4-]->[bk-3+]: bk-4 -> bk-4-[bk-4] -> st-29 -> st-30 -> cs-2[GREEN] -> st-25 -> st-26 -> bk-3+[bk-3]";
    String r6 = "Route: [bk-3+]->[bk-2-]: bk-3 -> bk-3+[bk-3] -> st-26 -> st-25 -> cs-2[RED] -> st-5 -> st-6 -> bk-2-[bk-2]";
    String r7 = "Route: [bk-1+]->[bk-4-]: bk-1 -> bk-1+[bk-1] -> st-1 -> st-2 -> cs-2[RED] -> st-30 -> st-29 -> bk-4-[bk-4]";
    String r8 = "Route: [bk-4-]->[bk-1+]: bk-4 -> bk-4-[bk-4] -> st-29 -> st-30 -> cs-2[RED] -> st-2 -> st-1 -> bk-1+[bk-1]";
