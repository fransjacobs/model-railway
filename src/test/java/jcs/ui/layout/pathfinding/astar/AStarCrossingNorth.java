 ...
 */
public class AStarCrossingNorth {

  private final PersistenceTestHelper testHelper;

  public AStarCrossingNorth() {
  ...
  @Before
  public void setUp() {
    testHelper.runTestDataInsertScript("layout_crossing_north_test.sql");
  }
  ...
  public void testFindPath_bk_1p_bk2m() {
    ...
    String expPath = "[bk-1+]->[bk-2-]: bk-1+[bk-1] -> st-1 -> st-2 -> cr-1 -> st-5 -> st-6 -> bk-2-[bk-2]";
  ...
  public void testFindPath_bk_4m_bk3p() {
    ...
    instance.buildGraph(tiles);
    String expPath = "[bk-4-]->[bk-3+]: bk-4-[bk-4] -> st-29 -> st-30 -> cr-1 -> st-25 -> st-26 -> bk-3+[bk-3]";
  ...
  public void testRouteAll() {
    ...
    String r1 = "Route: [bk-2-]->[bk-1+]: bk-2 -> bk-2-[bk-2] -> st-6 -> st-5 -> cr-1 -> st-2 -> st-1 -> bk-1+[bk-1]";
    String r2 = "Route: [bk-3+]->[bk-4-]: bk-3 -> bk-3+[bk-3] -> st-26 -> st-25 -> cr-1 -> st-30 -> st-29 -> bk-4-[bk-4]";
    String r3 = "Route: [bk-1+]->[bk-2-]: bk-1 -> bk-1+[bk-1] -> st-1 -> st-2 -> cr-1 -> st-5 -> st-6 -> bk-2-[bk-2]";
    String r4 = "Route: [bk-4-]->[bk-3+]: bk-4 -> bk-4-[bk-4] -> st-29 -> st-30 -> cr-1 -> st-25 -> st-26 -> bk-3+[bk-3]";
