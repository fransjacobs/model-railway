...
import jcs.ui.layout.tiles.Crossing;
 ...
 * @author fransjacobs
 */
public class CrossingTileTester extends javax.swing.JFrame {
  ...
  private void createTiles() {
    ...
    trackEast = new Crossing(TileBean.Orientation.EAST, 40, 40);
    trackEast.setId("east");
    trackEast.setTrackRouteColor(Color.MAGENTA);
    
    trackSouth = new Crossing(TileBean.Orientation.SOUTH, 120, 40);
    trackSouth.setId("south");
    trackSouth.setTrackRouteColor(Color.YELLOW);
    trackSouth.setIncomingSide(TileBean.Orientation.EAST);
    
    trackWest = new Crossing(TileBean.Orientation.WEST, 200, 40);
    trackWest.setId("west");
    trackWest.setTrackRouteColor(Color.CYAN);
    trackWest.setIncomingSide(TileBean.Orientation.NORTH);
    
    trackNorth = new Crossing(TileBean.Orientation.NORTH, 280, 40);
  ...
  public static void main(String args[]) {
    try {
      ...
      CrossingTileTester.setDefaultLookAndFeelDecorated(true);
    ...
    java.awt.EventQueue.invokeLater(() -> {
      CrossingTileTester app = new CrossingTileTester("CrossingTile Tester");
