 ...
 * @author Frans Jacobs
 */
public class StraightDirectionTileTester extends JFrame {
  ...
  public StraightDirectionTileTester(String title) {
    ...
    trackEast = new StraightDirection(Orientation.EAST, 70, 60);
    trackSouth = new StraightDirection(Orientation.SOUTH, 160, 60);
    trackWest = new StraightDirection(Orientation.WEST, 250, 60);
    trackNorth = new StraightDirection(Orientation.NORTH, 340, 60);
  }
  ...
  public static void main(String args[]) {
    ...
    StraightDirectionTileTester app = new StraightDirectionTileTester("Straight Tile Tester");
