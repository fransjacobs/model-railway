...
public class StraightTileTester extends javax.swing.JFrame {
  ...
  private void createTiles() {
    ...
    trackEast = new Straight(TileBean.Orientation.EAST, 40, 40);
    trackEast.setId("east");
    trackEast.setTrackRouteColor(Color.MAGENTA);

    trackSouth = new Straight(TileBean.Orientation.SOUTH, 120, 40);
    trackSouth.setId("south");
    trackSouth.setTrackRouteColor(Color.YELLOW);

    trackWest = new Straight(TileBean.Orientation.WEST, 200, 40);
    trackWest.setId("west");
    trackWest.setTrackRouteColor(Color.CYAN);

    trackNorth = new Straight(TileBean.Orientation.NORTH, 280, 40);
  ...
  private void drawCenterBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_drawCenterBtnActionPerformed
    ...
    this.trackEast.setDrawCenterPoint(this.drawCenterBtn.isSelected());
  ...
  public static void main(String args[]) {
    try {
      ...
      StraightTileTester.setDefaultLookAndFeelDecorated(true);
    ...
    java.awt.EventQueue.invokeLater(() -> {
      StraightTileTester app = new StraightTileTester("StraightTile Tester");
