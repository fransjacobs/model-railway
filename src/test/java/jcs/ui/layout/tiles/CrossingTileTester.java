 ...
 * @author Frans Jacobs
 */
public class CrossingTileTester extends JFrame {
  ...
  public CrossingTileTester(String title) {
    super(title);

    trackEast = new Crossing(Orientation.EAST, 70, 60);
    trackSouth = new Crossing(Orientation.SOUTH, 160, 60);
    trackWest = new Crossing(Orientation.WEST, 250, 60);
    trackNorth = new Crossing(Orientation.NORTH, 340, 60);
  }
  ...
  public static void main(String args[]) {
    ...
    CrossingTileTester app = new CrossingTileTester("Crossing Tile Tester");
