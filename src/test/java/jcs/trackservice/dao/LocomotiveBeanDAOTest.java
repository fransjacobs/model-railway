...
public class LocomotiveBeanDAOTest {
    ...
    public void setUp() {
        ...
        LocomotiveBean loco16390 = new LocomotiveBean(new BigDecimal(16390), "152 119-4 DBAG", null, 16390L, 2113628077L, 6, "DB BR 152 119-4", "mfx", "0x6", 140, 4, 28, 15, 255, "0", 0, 0, null, null);
        locomotives.add(loco16390);
        LocomotiveBean loco16391 = new LocomotiveBean(new BigDecimal(16391), "DB 640 017-9", "DB 640 017-9", 16391L, 2097006535L, 7, "DB BR 640 017-9", "mfx", "0x7", 100, 8, 15, 15, 64, null, 0, 1, null, null);
        locomotives.add(loco16391);
        LocomotiveBean loco16392 = new LocomotiveBean(new BigDecimal(16392), "BR 44 690", "BR 44 690", 16392L, 1945180592L, 8, "DB BR 44 100", "mfx", "0x8", 80, 5, 21, 12, 233, null, 0, 0, null, null);
        locomotives.add(loco16392);
        LocomotiveBean loco16393 = new LocomotiveBean(new BigDecimal(16393), "Rheingold 1", "Rheingold 1", 16393L, 1945195567L, 9, "DB BR 18 537", "mfx", "0x9", 81, 4, 12, 8, 255, null, 0, 0, null, null);
        locomotives.add(loco16393);
        LocomotiveBean loco16394 = new LocomotiveBean(new BigDecimal(16394), "561-05 RRF", "561-05 RRF", 16394L, 1945385732L, 10, "56-05 RRF", "mfx", "0xa", 120, 5, 31, 31, 220, "0", 0, 0, null, null);
        locomotives.add(loco16394);
        LocomotiveBean loco16395 = new LocomotiveBean(new BigDecimal(16395), "E 186 007-8 NS", null, 16395L, 1945441079L, 11, "NS 186 012-8", "mfx", "0xb", 140, 5, 16, 16, 255, null, 0, 1, null, null);
        locomotives.add(loco16395);
        LocomotiveBean loco16396 = new LocomotiveBean(new BigDecimal(16396), "BR 216 059-6", null, 16396L, 1945302187L, 12, "DB BR 216 059-6", "mfx", "0xc", 120, 5, 13, 13, 64, null, 0, 0, null, null);
        locomotives.add(loco16396);
        LocomotiveBean loco16397 = new LocomotiveBean(new BigDecimal(16397), "NS 1139", "NS 1139", 16397L, 4193976353L, 13, "NS 1136", "mfx", "0xd", 140, 6, 16, 4, 64, null, 0, 0, null, null);
    ...
    public void testFind() {
        ...
        assertEquals(expResult.getBlocks(), result.getBlocks());
