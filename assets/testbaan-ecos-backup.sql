...
('bk-1', 'bk-1', 'Blok 1', 0, 1, NULL, NULL, 1013, TRUE, 'Occupied', '-', 10, NULL, FALSE, TRUE, TRUE, 'Forwards', TRUE),
('bk-2', 'bk-2', 'Blok 2', 3, 2, NULL, NULL, NULL, TRUE, 'Free', NULL, 10, NULL, FALSE, TRUE, TRUE, NULL, TRUE),
('bk-3', 'bk-3', 'Blok 3', 9, 8, NULL, NULL, 1005, TRUE, 'Occupied', '-', 10, NULL, FALSE, TRUE, TRUE, 'Backwards', TRUE),
('bk-4', 'bk-4', 'Blok 4', 10, 11, NULL, NULL, NULL, TRUE, 'Free', NULL, 10, NULL, FALSE, TRUE, TRUE, NULL, TRUE);     
...
(0, 'M01-C01', 1, 1, 1, 0, NULL, NULL, 0, 0, 'esu-ecos'),
(1, 'M01-C02', 1, 2, 0, 1, NULL, NULL, 0, 0, 'esu-ecos'),
(2, 'M01-C03', 1, 3, 1, 1, 828, DATE '2025-10-12', 0, 0, 'esu-ecos'),
...
(11, 'M01-C12', 1, 12, 0, 1, NULL, NULL, 0, 0, 'esu-ecos'),
...
CREATE CACHED TABLE "jcs"."route_elements"(
    "id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 469) NOT NULL,
...
(19, '[bk-4+]->[bk-2+]', 'se-7', 'se-7', NULL, 2, 'East'),
(20, '[bk-4+]->[bk-2+]', 'st-11', 'st-11', NULL, 3, 'East'),
(21, '[bk-4+]->[bk-2+]', 'st-10', 'st-10', NULL, 4, 'East'),
(22, '[bk-4+]->[bk-2+]', 'sw-1', 'sw-1', 'G', 5, 'East'),
(23, '[bk-4+]->[bk-2+]', 'st-6', 'st-6', NULL, 6, 'East'),
(24, '[bk-4+]->[bk-2+]', 'sw-2', 'sw-2', 'G', 7, 'East'),
(25, '[bk-4+]->[bk-2+]', 'st-9', 'st-9', NULL, 8, 'East'),
(26, '[bk-4+]->[bk-2+]', 'st-8', 'st-8', NULL, 9, 'East'),
...
(32, '[bk-3-]->[bk-2+]', 'st-5', 'st-5', NULL, 3, 'East'),
(33, '[bk-3-]->[bk-2+]', 'ct-6', 'ct-6', NULL, 4, 'East'),
(34, '[bk-3-]->[bk-2+]', 'ct-4', 'ct-4', NULL, 5, 'North'),
(35, '[bk-3-]->[bk-2+]', 'ct-2', 'ct-2', NULL, 6, 'East'),
(36, '[bk-3-]->[bk-2+]', 'sw-1', 'sw-1', 'R', 7, 'North'),
(37, '[bk-3-]->[bk-2+]', 'st-6', 'st-6', NULL, 8, 'East'),
(38, '[bk-3-]->[bk-2+]', 'sw-2', 'sw-2', 'G', 9, 'East'),
(39, '[bk-3-]->[bk-2+]', 'st-9', 'st-9', NULL, 10, 'East'),
(40, '[bk-3-]->[bk-2+]', 'st-8', 'st-8', NULL, 11, 'East'),
...
(363, '[bk-1-]->[bk-4+]', 'bk-1', 'bk-1', NULL, 0, NULL),
(364, '[bk-1-]->[bk-4+]', 'bk-1-', 'bk-1', NULL, 1, NULL),
(365, '[bk-1-]->[bk-4+]', 'se-2', 'se-2', NULL, 2, 'West'),
(366, '[bk-1-]->[bk-4+]', 'st-7', 'st-7', NULL, 3, 'West'),
(367, '[bk-1-]->[bk-4+]', 'ct-5', 'ct-5', NULL, 4, 'West'),
(368, '[bk-1-]->[bk-4+]', 'ct-3', 'ct-3', NULL, 5, 'North'),
(369, '[bk-1-]->[bk-4+]', 'ct-1', 'ct-1', NULL, 6, 'West'),
(370, '[bk-1-]->[bk-4+]', 'sw-2', 'sw-2', 'R', 7, 'North'),
(371, '[bk-1-]->[bk-4+]', 'st-6', 'st-6', NULL, 8, 'West'),
(372, '[bk-1-]->[bk-4+]', 'sw-1', 'sw-1', 'G', 9, 'West'),
(373, '[bk-1-]->[bk-4+]', 'st-10', 'st-10', NULL, 10, 'West'),
(374, '[bk-1-]->[bk-4+]', 'st-11', 'st-11', NULL, 11, 'West'),
(375, '[bk-1-]->[bk-4+]', 'se-7', 'se-7', NULL, 12, 'West'),
(376, '[bk-1-]->[bk-4+]', 'bk-4+', 'bk-4', NULL, 13, 'West'),
(393, '[bk-3-]->[bk-1-]', 'bk-3', 'bk-3', NULL, 0, NULL),
(394, '[bk-3-]->[bk-1-]', 'bk-3-', 'bk-3', NULL, 1, NULL),
(395, '[bk-3-]->[bk-1-]', 'se-5', 'se-5', NULL, 2, 'East');       
INSERT INTO "jcs"."route_elements" VALUES
(396, '[bk-3-]->[bk-1-]', 'st-5', 'st-5', NULL, 3, 'East'),
(397, '[bk-3-]->[bk-1-]', 'ct-6', 'ct-6', NULL, 4, 'East'),
(398, '[bk-3-]->[bk-1-]', 'ct-4', 'ct-4', NULL, 5, 'North'),
(399, '[bk-3-]->[bk-1-]', 'ct-2', 'ct-2', NULL, 6, 'East'),
(400, '[bk-3-]->[bk-1-]', 'sw-1', 'sw-1', 'R', 7, 'North'),
(401, '[bk-3-]->[bk-1-]', 'st-6', 'st-6', NULL, 8, 'East'),
(402, '[bk-3-]->[bk-1-]', 'sw-2', 'sw-2', 'R', 9, 'East'),
(403, '[bk-3-]->[bk-1-]', 'ct-1', 'ct-1', NULL, 10, 'South'),
(404, '[bk-3-]->[bk-1-]', 'ct-3', 'ct-3', NULL, 11, 'East'),
(405, '[bk-3-]->[bk-1-]', 'ct-5', 'ct-5', NULL, 12, 'South'),
(406, '[bk-3-]->[bk-1-]', 'st-7', 'st-7', NULL, 13, 'East'),
(407, '[bk-3-]->[bk-1-]', 'se-2', 'se-2', NULL, 14, 'East'),
(408, '[bk-3-]->[bk-1-]', 'bk-1-', 'bk-1', NULL, 15, 'East'),
