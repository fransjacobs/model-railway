...
('se-1', 'Sensor', 'West', 'Center', 100, 60, NULL, NULL, 0),
('bk-1', 'Block', 'West', 'Center', 180, 60, NULL, NULL, NULL),
('se-2', 'Sensor', 'West', 'Center', 260, 60, NULL, NULL, 1),
...
('se-3', 'Sensor', 'West', 'Center', 100, 140, NULL, NULL, 2),
('bk-2', 'Block', 'East', 'Center', 180, 140, NULL, NULL, NULL),
('se-4', 'Sensor', 'West', 'Center', 260, 140, NULL, NULL, 3),
('si-2', 'Signal', 'East', 'Center', 300, 140, 'HP01', '20002', NULL),
('sw-1', 'Switch', 'East', 'Right', 380, 140, 'NONE', '20001', NULL),
...
('sw-2', 'Switch', 'West', 'Left', 460, 140, 'NONE', '20000', NULL),
...
('si-3', 'Signal', 'West', 'Center', 540, 60, 'HP01', '20005', NULL),
('si-4', 'Signal', 'West', 'Center', 540, 140, 'HP01', '20004', NULL),
('se-5', 'Sensor', 'West', 'Center', 580, 60, NULL, NULL, 8),
('se-6', 'Sensor', 'West', 'Center', 580, 140, NULL, NULL, 10),
...
('se-7', 'Sensor', 'West', 'Center', 740, 60, NULL, NULL, 9),
('se-8', 'Sensor', 'West', 'Center', 740, 140, NULL, NULL, 11),
...
(2, 'M01-C03', 1, 3, 0, 0, 0, DATE '2026-05-17', 0, 0, 'esu-ecos'),
(3, 'M01-C04', 1, 4, 0, 0, 0, DATE '2026-05-17', 0, 0, 'esu-ecos'),
...
('esu-ecos', 'ESU ECoS', 'ECoS', 'jcs.commandStation.esu.ecos.EsuEcosCommandStationImpl', 'NETWORK', NULL, '192.168.1.208', 15471, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, 'DCC,MFX,MM', FALSE, FALSE, '1', 'NETWORK', '0', 0, 0, 0, 0, 0, FALSE),
('intellibox2', 'Uhlenbrock Intellibox 2', 'Loconet', 'jcs.commandStation.loconet.Intellibox2Impl', 'SERIAL', 'tty.BLTH', 'AUTO', NULL, TRUE, TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, 'DCC,MM', TRUE, TRUE, '1', 'SERIAL', '0', 0, 0, 0, 0, 0, FALSE);      
...
('[bk-1-]->[bk-3-]', 'bk-1', '-', 'bk-3', '-', NULL, FALSE, NULL, NULL),
('[bk-4+]->[bk-2+]', 'bk-4', '+', 'bk-2', '+', NULL, FALSE, NULL, NULL),
...
('[bk-2+]->[bk-4+]', 'bk-2', '+', 'bk-4', '+', NULL, FALSE, NULL, NULL),
('[bk-3-]->[bk-1-]', 'bk-3', '-', 'bk-1', '-', NULL, FALSE, NULL, NULL);      
...
CREATE CACHED TABLE "jcs"."route_elements"(
    "id" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 173) NOT NULL,
...
(1, '[bk-1-]->[bk-3-]', 'bk-1', 'bk-1', NULL, 0, NULL),
(2, '[bk-1-]->[bk-3-]', 'bk-1-', 'bk-1', NULL, 1, NULL),
(3, '[bk-1-]->[bk-3-]', 'se-2', 'se-2', NULL, 2, 'West'),
(4, '[bk-1-]->[bk-3-]', 'si-1', 'si-1', NULL, 3, 'West'),
(5, '[bk-1-]->[bk-3-]', 'ct-3', 'ct-3', NULL, 4, 'West'),
(6, '[bk-1-]->[bk-3-]', 'ct-2', 'ct-2', NULL, 5, 'North'),
(7, '[bk-1-]->[bk-3-]', 'ct-1', 'ct-1', NULL, 6, 'West'),
(8, '[bk-1-]->[bk-3-]', 'sw-1', 'sw-1', 'R', 7, 'North'),
(9, '[bk-1-]->[bk-3-]', 'st-3', 'st-3', NULL, 8, 'West'),
(10, '[bk-1-]->[bk-3-]', 'sw-2', 'sw-2', 'R', 9, 'West'),
(11, '[bk-1-]->[bk-3-]', 'ct-4', 'ct-4', NULL, 10, 'South'),
(12, '[bk-1-]->[bk-3-]', 'ct-5', 'ct-5', NULL, 11, 'West'),
(13, '[bk-1-]->[bk-3-]', 'ct-6', 'ct-6', NULL, 12, 'South'),
(14, '[bk-1-]->[bk-3-]', 'si-3', 'si-3', NULL, 13, 'West'),
(15, '[bk-1-]->[bk-3-]', 'se-5', 'se-5', NULL, 14, 'West'),
(16, '[bk-1-]->[bk-3-]', 'bk-3-', 'bk-3', NULL, 15, 'West'),
(17, '[bk-4+]->[bk-2+]', 'bk-4', 'bk-4', NULL, 0, NULL),
(18, '[bk-4+]->[bk-2+]', 'bk-4+', 'bk-4', NULL, 1, NULL),
(19, '[bk-4+]->[bk-2+]', 'se-6', 'se-6', NULL, 2, 'East'),
(20, '[bk-4+]->[bk-2+]', 'si-4', 'si-4', NULL, 3, 'East'),
(21, '[bk-4+]->[bk-2+]', 'st-5', 'st-5', NULL, 4, 'East'),
(22, '[bk-4+]->[bk-2+]', 'sw-2', 'sw-2', 'G', 5, 'East'),
(23, '[bk-4+]->[bk-2+]', 'st-3', 'st-3', NULL, 6, 'East'),
(24, '[bk-4+]->[bk-2+]', 'sw-1', 'sw-1', 'G', 7, 'East'),
(25, '[bk-4+]->[bk-2+]', 'st-4', 'st-4', NULL, 8, 'East'),
(26, '[bk-4+]->[bk-2+]', 'si-2', 'si-2', NULL, 9, 'East'),
(27, '[bk-4+]->[bk-2+]', 'se-4', 'se-4', NULL, 10, 'East'),
(28, '[bk-4+]->[bk-2+]', 'bk-2+', 'bk-2', NULL, 11, 'East'),
(29, '[bk-3-]->[bk-2+]', 'bk-3', 'bk-3', NULL, 0, NULL),
(30, '[bk-3-]->[bk-2+]', 'bk-3-', 'bk-3', NULL, 1, NULL),
(31, '[bk-3-]->[bk-2+]', 'se-5', 'se-5', NULL, 2, 'East'),
(32, '[bk-3-]->[bk-2+]', 'si-3', 'si-3', NULL, 3, 'East'),
(33, '[bk-3-]->[bk-2+]', 'ct-6', 'ct-6', NULL, 4, 'East'),
(34, '[bk-3-]->[bk-2+]', 'ct-5', 'ct-5', NULL, 5, 'North'),
(35, '[bk-3-]->[bk-2+]', 'ct-4', 'ct-4', NULL, 6, 'East'),
(36, '[bk-3-]->[bk-2+]', 'sw-2', 'sw-2', 'R', 7, 'North'),
(37, '[bk-3-]->[bk-2+]', 'st-3', 'st-3', NULL, 8, 'East'),
(38, '[bk-3-]->[bk-2+]', 'sw-1', 'sw-1', 'G', 9, 'East'),
(39, '[bk-3-]->[bk-2+]', 'st-4', 'st-4', NULL, 10, 'East'),
(40, '[bk-3-]->[bk-2+]', 'si-2', 'si-2', NULL, 11, 'East'),
(41, '[bk-3-]->[bk-2+]', 'se-4', 'se-4', NULL, 12, 'East'),
(42, '[bk-3-]->[bk-2+]', 'bk-2+', 'bk-2', NULL, 13, 'East'),
(57, '[bk-2+]->[bk-3-]', 'bk-2', 'bk-2', NULL, 0, NULL),
(58, '[bk-2+]->[bk-3-]', 'bk-2+', 'bk-2', NULL, 1, NULL),
(59, '[bk-2+]->[bk-3-]', 'se-4', 'se-4', NULL, 2, 'West'),
(60, '[bk-2+]->[bk-3-]', 'si-2', 'si-2', NULL, 3, 'West'),
(61, '[bk-2+]->[bk-3-]', 'st-4', 'st-4', NULL, 4, 'West'),
(62, '[bk-2+]->[bk-3-]', 'sw-1', 'sw-1', 'G', 5, 'West'),
(63, '[bk-2+]->[bk-3-]', 'st-3', 'st-3', NULL, 6, 'West'),
(64, '[bk-2+]->[bk-3-]', 'sw-2', 'sw-2', 'R', 7, 'West'),
(65, '[bk-2+]->[bk-3-]', 'ct-4', 'ct-4', NULL, 8, 'South'),
(66, '[bk-2+]->[bk-3-]', 'ct-5', 'ct-5', NULL, 9, 'West'),
(67, '[bk-2+]->[bk-3-]', 'ct-6', 'ct-6', NULL, 10, 'South'),
(68, '[bk-2+]->[bk-3-]', 'si-3', 'si-3', NULL, 11, 'West'),
(69, '[bk-2+]->[bk-3-]', 'se-5', 'se-5', NULL, 12, 'West'),
(70, '[bk-2+]->[bk-3-]', 'bk-3-', 'bk-3', NULL, 13, 'West'),
(71, '[bk-4+]->[bk-1-]', 'bk-4', 'bk-4', NULL, 0, NULL),
(72, '[bk-4+]->[bk-1-]', 'bk-4+', 'bk-4', NULL, 1, NULL),
(73, '[bk-4+]->[bk-1-]', 'se-6', 'se-6', NULL, 2, 'East'),
(74, '[bk-4+]->[bk-1-]', 'si-4', 'si-4', NULL, 3, 'East'),
(75, '[bk-4+]->[bk-1-]', 'st-5', 'st-5', NULL, 4, 'East'),
(76, '[bk-4+]->[bk-1-]', 'sw-2', 'sw-2', 'G', 5, 'East'),
(77, '[bk-4+]->[bk-1-]', 'st-3', 'st-3', NULL, 6, 'East'),
(78, '[bk-4+]->[bk-1-]', 'sw-1', 'sw-1', 'R', 7, 'East'),
(79, '[bk-4+]->[bk-1-]', 'ct-1', 'ct-1', NULL, 8, 'South'),
(80, '[bk-4+]->[bk-1-]', 'ct-2', 'ct-2', NULL, 9, 'East'),
(81, '[bk-4+]->[bk-1-]', 'ct-3', 'ct-3', NULL, 10, 'South'),
(82, '[bk-4+]->[bk-1-]', 'si-1', 'si-1', NULL, 11, 'East'),
(83, '[bk-4+]->[bk-1-]', 'se-2', 'se-2', NULL, 12, 'East');
INSERT INTO "jcs"."route_elements" VALUES
(84, '[bk-4+]->[bk-1-]', 'bk-1-', 'bk-1', NULL, 13, 'East'),
(85, '[bk-2+]->[bk-4+]', 'bk-2', 'bk-2', NULL, 0, NULL),
(86, '[bk-2+]->[bk-4+]', 'bk-2+', 'bk-2', NULL, 1, NULL),
(87, '[bk-2+]->[bk-4+]', 'se-4', 'se-4', NULL, 2, 'West'),
(88, '[bk-2+]->[bk-4+]', 'si-2', 'si-2', NULL, 3, 'West'),
(89, '[bk-2+]->[bk-4+]', 'st-4', 'st-4', NULL, 4, 'West'),
(90, '[bk-2+]->[bk-4+]', 'sw-1', 'sw-1', 'G', 5, 'West'),
(91, '[bk-2+]->[bk-4+]', 'st-3', 'st-3', NULL, 6, 'West'),
(92, '[bk-2+]->[bk-4+]', 'sw-2', 'sw-2', 'G', 7, 'West'),
(93, '[bk-2+]->[bk-4+]', 'st-5', 'st-5', NULL, 8, 'West'),
(94, '[bk-2+]->[bk-4+]', 'si-4', 'si-4', NULL, 9, 'West'),
(95, '[bk-2+]->[bk-4+]', 'se-6', 'se-6', NULL, 10, 'West'),
(96, '[bk-2+]->[bk-4+]', 'bk-4+', 'bk-4', NULL, 11, 'West'),
(127, '[bk-1-]->[bk-4+]', 'bk-1', 'bk-1', NULL, 0, NULL),
(128, '[bk-1-]->[bk-4+]', 'bk-1-', 'bk-1', NULL, 1, NULL),
(129, '[bk-1-]->[bk-4+]', 'se-2', 'se-2', NULL, 2, 'West'),
(130, '[bk-1-]->[bk-4+]', 'si-1', 'si-1', NULL, 3, 'West'),
(131, '[bk-1-]->[bk-4+]', 'ct-3', 'ct-3', NULL, 4, 'West'),
(132, '[bk-1-]->[bk-4+]', 'ct-2', 'ct-2', NULL, 5, 'North'),
(133, '[bk-1-]->[bk-4+]', 'ct-1', 'ct-1', NULL, 6, 'West'),
(134, '[bk-1-]->[bk-4+]', 'sw-1', 'sw-1', 'R', 7, 'North'),
(135, '[bk-1-]->[bk-4+]', 'st-3', 'st-3', NULL, 8, 'West'),
(136, '[bk-1-]->[bk-4+]', 'sw-2', 'sw-2', 'G', 9, 'West'),
(137, '[bk-1-]->[bk-4+]', 'st-5', 'st-5', NULL, 10, 'West'),
(138, '[bk-1-]->[bk-4+]', 'si-4', 'si-4', NULL, 11, 'West'),
(139, '[bk-1-]->[bk-4+]', 'se-6', 'se-6', NULL, 12, 'West'),
(140, '[bk-1-]->[bk-4+]', 'bk-4+', 'bk-4', NULL, 13, 'West'),
(157, '[bk-3-]->[bk-1-]', 'bk-3', 'bk-3', NULL, 0, NULL),
(158, '[bk-3-]->[bk-1-]', 'bk-3-', 'bk-3', NULL, 1, NULL),
(159, '[bk-3-]->[bk-1-]', 'se-5', 'se-5', NULL, 2, 'East'),
(160, '[bk-3-]->[bk-1-]', 'si-3', 'si-3', NULL, 3, 'East'),
(161, '[bk-3-]->[bk-1-]', 'ct-6', 'ct-6', NULL, 4, 'East'),
(162, '[bk-3-]->[bk-1-]', 'ct-5', 'ct-5', NULL, 5, 'North'),
(163, '[bk-3-]->[bk-1-]', 'ct-4', 'ct-4', NULL, 6, 'East'),
(164, '[bk-3-]->[bk-1-]', 'sw-2', 'sw-2', 'R', 7, 'North'),
(165, '[bk-3-]->[bk-1-]', 'st-3', 'st-3', NULL, 8, 'East'),
(166, '[bk-3-]->[bk-1-]', 'sw-1', 'sw-1', 'R', 9, 'East'),
(167, '[bk-3-]->[bk-1-]', 'ct-1', 'ct-1', NULL, 10, 'South'),
(168, '[bk-3-]->[bk-1-]', 'ct-2', 'ct-2', NULL, 11, 'East'),
(169, '[bk-3-]->[bk-1-]', 'ct-3', 'ct-3', NULL, 12, 'South'),
(170, '[bk-3-]->[bk-1-]', 'si-1', 'si-1', NULL, 13, 'East'),
(171, '[bk-3-]->[bk-1-]', 'se-2', 'se-2', NULL, 14, 'East'),
(172, '[bk-3-]->[bk-1-]', 'bk-1-', 'bk-1', NULL, 15, 'East');       
